...
{
    return [[[[NSRailConnection sharedInstance] normalizeString:[[element firstChildWithClassName:@"travel-time"] text]] stringByReplacingOccurrencesOfString:@"0:" withString:@""] stringByReplacingOccurrencesOfString:@":" withString:@"h "];
}
...
- (NSArray *)trainsWithData:(NSData *)data
{
    ...
    for (DDXMLElement *element in elements) {
        ...
        [train setTravelTime:[[[[NSRailConnection sharedInstance] normalizeString:[[[element nodesForXPath:@"reistijd" error:nil] objectAtIndex:0] stringValue]] stringByReplacingOccurrencesOfString:@"0:" withString:@""] stringByReplacingOccurrencesOfString:@":" withString:@"h "]];
